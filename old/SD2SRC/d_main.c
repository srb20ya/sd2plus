    ...
    switch (demosequence)
      ...
      case 0:
        if ( gamemode == commercial )
          pagetic = TICRATE * 3;        // killough 2/22/98: use TICRATE
        else
      ...
      case 2:
        if ( gamemode == commercial )
          pagetic = TICRATE * 18;        // killough 2/22/98: use TICRATE
        else
          pagetic = (TICRATE*170)/35;    // killough 2/22/98: use TICRATE
        gamestate = GS_DEMOSCREEN;
        pagename = "TITLEPIC";
    ...
    switch(gamemode)
    {
      ...
      case commercial:
        ...
        else if (i>=12 && !strnicmp(iwad+i-12,"plutonia.wad",12))
        {
          ...
          //jff 9/3/98 use logical output routine
          lprintf(LO_CONFIRM,"Sonic DOOM II: Bots on Mobius version%s\n",haswolflevels? "" : ", german edition, no wolf levels");
        break;
      default:
        gamemission = none;
        break;
    ...
    case commercial:  // Ty 08/27/98 - fixed gamemode vs gamemission
      switch (gamemission)
      {
        ...
        default:
          sprintf (title,
               "           "
               "Sonic Doom 2: Bots on Mobius Final Edition v1.0"
               "                           ",
               VERSION/100,VERSION%100);
          break;
      }
