...
void G_DoLoadLevel (void)
{
  ...
  if (gamemode == commercial)
    ...
    {
      if (gamemap == 32)
	  skytexture = R_TextureNumForName ("SKY32");
	else
      if (gamemap == 31)
        skytexture = R_TextureNumForName ("SKY31");
      else
        if (gamemap == 30)
          skytexture = R_TextureNumForName ("SKY30");
      else
        if (gamemap == 29)
          skytexture = R_TextureNumForName ("SKY29");
	else
        if (gamemap == 28)
          skytexture = R_TextureNumForName ("SKY28");
	else
        if (gamemap == 27)
          skytexture = R_TextureNumForName ("SKY27");
	else
        if (gamemap == 26)
          skytexture = R_TextureNumForName ("SKY26");
	else
        if (gamemap == 25)
          skytexture = R_TextureNumForName ("SKY25");
	else
        if (gamemap == 24)
          skytexture = R_TextureNumForName ("SKY24");
	else
        if (gamemap == 23)
          skytexture = R_TextureNumForName ("SKY23");
	else
        if (gamemap == 22)
          skytexture = R_TextureNumForName ("SKY22");
	else
        if (gamemap == 21)
          skytexture = R_TextureNumForName ("SKY21");
	else
        if (gamemap == 20)
          skytexture = R_TextureNumForName ("SKY20");
	else
        if (gamemap == 19)
          skytexture = R_TextureNumForName ("SKY19");
	else
        if (gamemap == 18)
          skytexture = R_TextureNumForName ("SKY18");
	else
        if (gamemap == 17)
          skytexture = R_TextureNumForName ("SKY17");
	else
        if (gamemap == 16)
          skytexture = R_TextureNumForName ("SKY16");
	else
        if (gamemap == 15)
          skytexture = R_TextureNumForName ("SKY15");
	else
        if (gamemap == 14)
          skytexture = R_TextureNumForName ("SKY14");
	else
        if (gamemap == 13)
          skytexture = R_TextureNumForName ("SKY13");
	else
        if (gamemap == 12)
          skytexture = R_TextureNumForName ("SKY12");
	else
        if (gamemap == 11)
          skytexture = R_TextureNumForName ("SKY11");
	else
        if (gamemap == 10)
          skytexture = R_TextureNumForName ("SKY10");
	else
        if (gamemap == 9)
          skytexture = R_TextureNumForName ("SKY9");
	else
        if (gamemap == 8)
          skytexture = R_TextureNumForName ("SKY8");
	else
        if (gamemap == 7)
          skytexture = R_TextureNumForName ("SKY7");
	else
        if (gamemap == 6)
          skytexture = R_TextureNumForName ("SKY6");
	else
        if (gamemap == 5)
