...
struct cheat_s cheat[] = {
  {"sdmus",      "Change music",      always,
   cheat_mus,      -2},

  {"sdspin", "Chainsaw",          not_net | not_demo,
   cheat_choppers },

  {"emerald",      "God mode",          not_net | not_demo,
   cheat_god      },
  ...
  {"unlockgun",      "Ammo & Keys",       not_net | not_demo,
   cheat_kfa },

  {"gunstuff",       "Ammo",              not_net | not_demo,
   cheat_fa  },

  {"lookma", "No Clipping 1",     not_net | not_demo,
   cheat_noclip },

  {"lookma",     "No Clipping 2",     not_net | not_demo,
   cheat_noclip },

  {"ouch",  "Invincibility",     not_net | not_demo,
   cheat_pw,  pw_invulnerability },

  {"chuckles",  "Berserk",           not_net | not_demo,
   cheat_pw,  pw_strength        },

  {"espio",  "Invisibility",      not_net | not_demo,  
   cheat_pw,  pw_invisibility    },

  {"whoom",  "Radiation Suit",    not_net | not_demo,
   cheat_pw,  pw_ironfeet        },

  {"lemmesee",  "Auto-map",          not_net | not_demo,
   cheat_pw,  pw_allmap          },

  {"waypast",  "Lite-Amp Goggles",  not_net | not_demo,
   cheat_pw,  pw_infrared        },

  {"spiffy",   "BEHOLD menu",       not_net | not_demo,
   cheat_behold   },

  {"zoom",     "Level Warp",        not_net | not_demo | not_menu,
   cheat_clev,    -2},

  {"sdhere",    "Player Position",   not_net | not_demo,
   cheat_mypos    },

  {"sdcomp",    NULL,                not_net | not_demo,
   cheat_comp     },     // phares

  {"sdem",      NULL,                not_net | not_demo,
   cheat_massacre },     // jff 2/01/98 kill all monsters

  {"ooh",       "Map cheat",         not_dm  | not_demo,
   cheat_ddt      },     // killough 2/07/98: moved from am_map.c

  {"sdhom",     NULL,                not_net | not_demo,
   cheat_hom      },     // killough 2/07/98: HOM autodetector

  {"sdkey",     NULL,                not_net | not_demo, 
   cheat_tntkey   },     // killough 2/16/98: generalized key cheats

  {"sdkeyr",    NULL,                not_net | not_demo,
   cheat_tntkeyx  },

  {"sdkeyy",    NULL,                not_net | not_demo,
   cheat_tntkeyx  },

  {"sdkeyb",    NULL,                not_net | not_demo,
   cheat_tntkeyx  },

  {"sdkeyrc",   NULL,                not_net | not_demo, 
   cheat_tntkeyxx, it_redcard    },

  {"sdkeyyc",   NULL,                not_net | not_demo,
   cheat_tntkeyxx, it_yellowcard },

  {"sdkeybc",   NULL,                not_net | not_demo, 
   cheat_tntkeyxx, it_bluecard   },

  {"sdkeyrs",   NULL,                not_net | not_demo,
   cheat_tntkeyxx, it_redskull   },

  {"sdkeyys",   NULL,                not_net | not_demo,
   cheat_tntkeyxx, it_yellowskull},

  {"sdkeybs",   NULL,                not_net | not_demo,
   cheat_tntkeyxx, it_blueskull  },  // killough 2/16/98: end generalized keys

  {"sdka",      NULL,                not_net | not_demo,
   cheat_k    },         // Ty 04/11/98 - Added TNTKA

  {"sdweap",    NULL,                not_net | not_demo,
   cheat_tntweap  },     // killough 2/16/98: generalized weapon cheats

  {"sdweap",    NULL,                not_net | not_demo,
   cheat_tntweapx, -1},

  {"sdammo",    NULL,                not_net | not_demo,
   cheat_tntammo  },

  {"sdstuff",    NULL,                not_net | not_demo,
   cheat_tntammox, -1},  // killough 2/16/98: end generalized weapons

  {"sdtran",    NULL,                always,
   cheat_tnttran  },     // invoke translucency         // phares

  {"sdsmart",   NULL,                not_net | not_demo,
...
static void cheat_fast()
{
  plyr->message = (fastparm = !fastparm) ? "Fast Robots On" : 
    "Fast Robots Off";  // Ty 03/27/98 - *not* externalized
...
static void cheat_smart()
{
  ...
  plyr->message = (monsters_remember = !monsters_remember) ? 
    "Smart Robots Enabled" : "Smart Robots Disabled";
}
